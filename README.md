			...
			<ol>
			 ...
			 <h3 id='n4.2'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <ins>Browser extensions</ins></h3>
				<ul>
					...
					<li>Cookies and HTTP Headers analyser (<a href='https://addons.mozilla.org/en-US/firefox/addon/cookies-and-headers-analyser/'>Mozilla</a>) - This extension analyses, according to OWASP guidelines, the cookies and the headers in the active tab.</li>
